...
(function () {
  ...
  function blocoCompra(p) {
    ...
    if (p.checkout) {
      ...
      /* sem link de pagamento configurado: encaminha para o contato
         em vez de deixar um botão quebrado */
      var reserva = criar("a", "botao botao-compra botao-reserva", "Reservar por " +
                          formatarPreco(p.preco));
      reserva.href = "#/contato";
      compra.appendChild(reserva);
      compra.appendChild(criar("p", "compra-aviso",
        "Link de pagamento em configuração. Escreva para nós e garantimos o seu."));
    }
